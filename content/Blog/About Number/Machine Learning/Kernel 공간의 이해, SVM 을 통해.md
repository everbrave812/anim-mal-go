...
description: "비선형 분류 문제를 출발점으로 SVM을 듀얼 문제로 바꾸는 이유를 설명한다. 라그랑지안과 KKT 조건을 예제로 살펴보고, 데이터의 내적을 커널 함수로 바꾸는 커널 트릭의 아이디어를 소개한다."
date: 2026-08-25
publish: true
---
### Motivation
...
![[Pasted image 20260830030407.png|241]]
